...
export const MiniCards: React.FC<MiniCardsProps> = ({ ...props }) => {
  return (
    <Card className={styles.wrapper}>
      ...
      <Card className={styles.card} elevation={Elevation.THREE}>
        ...
        <span />
        <Button className={styles.btn} intent="primary" icon="cross" />
      </Card>
      <Callout
      ...
      >
        <p className={`${styles.title} ${styles.sub}`}>
          Aliquam imperdiet lacus quam, imperdiet fermentum lectus pretium
          vitae. Curabitur quis porttitor lorem, sed porttitor erat. Vestibulum
          ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia
          curae; Nullam et blandit nisi. Curabitur iaculis vitae tellus sed
          hendrerit. Vestibulum fringilla massa in quam iaculis ullamcorper.
        </p>
      </Callout>
    </Card>
  );
