  ...
  return (
    ...
    >
      ...
      <Card className={`${styles.card} ${styles.body}`}>
        <H1 className={`${styles.typo} ${styles.title}`}>
          LASHES & HAIR EXTENTIONS
        </H1>
        <H5 className={`${styles.typo} ${styles.desc}`}>
          Donec faucibus, ante ut ultrices commodo, magna ex maximus, sodales
          neque dolor vitae arcu. Nam euismod, neque quis laoreet interdum. Sed
          magna est, dictum at faucibus.
        </H5>
        <Card className={`${styles.card} ${styles.promo}`}>
          <H6 className={`${styles.typo} ${styles.promo} ${styles.email}`}>
